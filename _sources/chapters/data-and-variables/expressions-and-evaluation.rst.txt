...
If you ask C# to print an expression using ``Console.WriteLine``, the interpreter **evaluates** the expression and displays the result.
...
This code does not print ``1 + 1`` but rather the *result* of calculating ``1 + 1``. In other words, ``Console.WriteLine(1 + 1)`` prints the value ``2``. This is what we would expect.
