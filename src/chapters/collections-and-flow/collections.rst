...
When working with collections, you will need to call upon the following library:  ``System.Collections.Generic`` .
In your replit, you will need to manually add this below the ``using System`` statement in **Line 1** of your IDE.

This lets your compiler know that it will need to be aware of methods, properies and other rules of any collection type you use.
